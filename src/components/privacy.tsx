        ...
        <AnimatedComponent animation="fadeIn">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              How FinZuu protects and manages your personal information
            </p>
            ...
            <Card className="rounded-xl">
              <TabsContent value="overview" className="p-6">
                ...
                <CardContent className="px-0 space-y-6">
                  <p>
                    This Privacy Policy describes how FinZuu ("we", "us", or "our") collects, uses, and shares your personal information
                  ...
                  <div className="mt-6">
                    ...
                    <div className="flex items-center mt-2">
                      ...
                      <a href="mailto:legal@finzuu.com" className="text-primary hover:underline">
                        legal@finzuu.com
                      </a>
                    </div>
                  </div>
                ...
                <CardContent className="px-0 space-y-6">
                  ...
                  <div className="bg-primary/5 p-5 rounded-lg mt-6">
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li className="flex items-start">
                        <ShieldCheck className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                        <span>Contact our Data Protection Officer at <a href="mailto:legal@finzuu.com" className="text-primary hover:underline">legal@finzuu.com</a></span>
                      </li>
                      <li className="flex items-start">
                        <ShieldCheck className="h-4 w-4 text-primary mr-2 mt-0.5 flex-shrink-0" />
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-sm">
                      Our Services are not intended for children under the age of 18. We do not knowingly collect or solicit personal information from children under 18. If you are under 18, please do not attempt to register for our Services or send any personal information about yourself to us. If we learn that we have collected personal information from a child under 18, we will delete that information as quickly as possible. If you believe that a child under 18 may have provided us with personal information, please contact us at <a href="mailto:legal@finzuu.com" className="text-primary hover:underline">legal@finzuu.com</a>.
                    </p>
                  </div>
                </CardContent>
              </TabsContent>
