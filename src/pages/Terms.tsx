      ...
      <div className="container mx-auto py-12 px-4 max-w-5xl">
        ...
        <Card className="mb-8 rounded-xl">
          ...
          <CardContent className="space-y-4">
            <p>
              These Terms of Service ("Terms") govern your access to and use of the ReadyCash platform and related services (collectively, the "Services") provided by FinZuu ("we," "us," or "our").
            </p>
            <p>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-4">
              <div className="flex items-start">
                ...
                <p className="text-sm text-amber-800">
                  These Terms constitute a legally binding agreement between you and FinZuu. If you are using our Services on behalf of a business or other entity, you represent that you have the authority to bind that entity to these Terms.
                </p>
              </div>
            </div>
          </CardContent>
        ...
        <AnimatedComponent animation="fadeIn" delay={0.1}>
          <Accordion type="single" collapsible className="mb-8">
            ...
            <AccordionItem value="ip-rights">
              ...
              <AccordionContent className="space-y-4 pt-2 pb-4">
                <p>
                  All content included in or made available through our Services, including but not limited to text, graphics, logos, icons, images, audio clips, digital downloads, data compilations, and software, is the property of FinZuu or its content suppliers and is protected by international copyright, trademark, and other intellectual property laws.
                </p>
                <p>
            ...
            <AccordionItem value="limitations">
              ...
              <AccordionContent className="space-y-4 pt-2 pb-4">
                <p>
                  To the maximum extent permitted by applicable law, FinZuu and its affiliates, officers, employees, agents, partners, and licensors shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation damages for loss of profits, data, use, goodwill, or other intangible losses, resulting from:
                </p>
                <ul className="list-disc pl-6 space-y-2">
            ...
            <AccordionItem value="indemnification">
              ...
              <AccordionContent className="space-y-4 pt-2 pb-4">
                <p>
                  You agree to indemnify, defend, and hold harmless FinZuu and its affiliates, officers, directors, employees, agents, licensors, and service providers from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses, or fees (including reasonable attorneys' fees) arising out of or relating to:
                </p>
                <ul className="list-disc pl-6 space-y-2">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <div className="flex items-center">
                ...
                <span>FinZuu, 23-25 rue Jean-Jacques Rousseau, 75001 Paris – France</span>
              </div>
            </div>
          </div>
        </div>
